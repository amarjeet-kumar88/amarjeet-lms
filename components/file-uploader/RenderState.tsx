...
import { CloudAlertIcon, ImageIcon, Loader2, XIcon } from "lucide-react";
...
export function RenderErrorState() {
  return (
    <div className="text-center">
      ...
      <p className="text-xs mi-1 text-muted-foreground">Something went wrong</p>
