...
export async function createChapter(values: ChapterSchemaType): Promise<ApiResponse> {
    ...
    try {
        ...
        await prisma.$transaction(async (tx) => {
            const mxPos = await tx.chapter.findFirst({
                where: {
...
export async function createLesson(values: ChapterSchemaType): Promise<ApiResponse> {
    ...
    try {
        ...
        await prisma.$transaction(async (tx) => {
            const mxPos = await tx.lesson.findFirst({
                where: {
...
export async function deleteLesson({
    ...
    try {
        ...
        return {
            status: "success",
            message: "Lesson deleted and position reordered succesfully",
        }
...
export async function deleteChapter({
    ...
    try {
        ...
        return {
            status: "success",
            message: "Chapter deleted and position reordered succesfully",
        }
