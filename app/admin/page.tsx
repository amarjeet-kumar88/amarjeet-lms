...
import AdminCourseCardSkeleton, { AdminCourseCard } from "./courses/_components/AdminCourseCard";
    ...
    <>
      ...
      <div className="space-y-4">
        <div className=" flex items-center justify-between">
          ...
          <Link href="/admin/courses" className={buttonVariants({variant: "outline"})}>View All Courses</Link>
        </div>
